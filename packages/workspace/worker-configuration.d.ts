/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7b4cebd2834a62038ac4dc98cd7a1b8e)
// Runtime types generated with workerd@1.20260609.1 2026-05-22
interface __BaseEnv_Env {
	WORKSPACE_OBJECTS: DurableObjectNamespace<import("./src/workers").WorkspaceObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/workers");
		durableNamespaces: "WorkspaceObject";
	}
