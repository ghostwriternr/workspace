...
import { createWorkspaceBackedRuntime, type WorkspaceBackedRuntime } from "./workspace-runtime";
...
export interface WorkspaceRunLease {
  id: string;
}

export interface WorkspaceRuntimeFactoryOptions {
...
export type WorkspaceRuntimeFactory = (lease: WorkspaceRunLease) => Promise<WorkspaceBackedRuntime>;

export function createWorkspaceRuntimeFactory(options: WorkspaceRuntimeFactoryOptions): WorkspaceRuntimeFactory {
  return async (lease) => {
