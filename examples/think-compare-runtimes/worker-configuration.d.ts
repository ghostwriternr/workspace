/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6296bc683eb51f158141cb0c19fb6986)
// Runtime types generated with workerd@1.20260616.1 2026-06-10 experimental,nodejs_compat
interface __BaseEnv_Env {
	ARTIFACTS: Artifacts;
	DYNAMIC_WORKERS: WorkerLoader;
	AI: Ai;
	...
	WorkspaceSandbox: DurableObjectNamespace<import("./worker/index").WorkspaceSandbox>;
	WORKSPACE_OBJECTS: DurableObjectNamespace<import("./worker/index").WorkspaceObject>;
	CompareRun: DurableObjectNamespace<import("./worker/index").CompareRun>;
	WorkspaceRuntimeAgent: DurableObjectNamespace<import("./worker/index").WorkspaceRuntimeAgent>;
	SandboxRuntimeAgent: DurableObjectNamespace<import("./worker/index").SandboxRuntimeAgent>;
	WorkspaceSandboxWarmPool: DurableObjectNamespace<import("./worker/index").WorkspaceSandboxWarmPool>;
	RawSandboxWarmPool: DurableObjectNamespace<import("./worker/index").RawSandboxWarmPool>;
	SELF: Service<typeof import("./worker/index").default>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "Sandbox" | "WorkspaceObject" | "WorkspaceRuntimeAgent" | "SandboxRuntimeAgent" | "CompareRun" | "WorkspaceSandbox" | "WorkspaceSandboxWarmPool" | "RawSandboxWarmPool";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONTAINER_SLEEP_AFTER" | "SANDBOX_TRANSPORT" | "WARM_POOL_REFRESH_INTERVAL" | "WARM_POOL_TARGET">> {}
}
