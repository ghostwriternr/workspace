/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b19855df77b3749ecd63a2b5fd1646e6)
// Runtime types generated with workerd@1.20260609.1 2026-06-10 experimental,nodejs_compat
interface __BaseEnv_Env {
	ARTIFACTS: Artifacts;
	DYNAMIC_WORKERS: WorkerLoader;
	AI: Ai;
	SANDBOX_TRANSPORT: "rpc";
	PhotoAgent: DurableObjectNamespace<import("./src/index").PhotoAgent>;
	Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
	WORKSPACE_OBJECTS: DurableObjectNamespace<import("./src/index").WorkspaceObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PhotoAgent" | "Sandbox" | "WorkspaceObject";
	}
